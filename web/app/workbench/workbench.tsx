...
export default function Workbench({ active }: { active: boolean }) {
  ...
  useEffect(() => {
    if (!active || !document.modelContext?.registerTool) return;
  ...
  return (
    <section className="embedded-workbench" aria-label="Recovery workbench">
      <div className="workbench-intro">
        <h2>The recovery workbench</h2>
        <p>
          Try the published example, check a share, or print practice cards.
        </p>
      </div>
      {engineFailed && (
        <div className="error-banner" role="alert">
          <p>The recovery library could not load.</p>
          <button className="text-button" onClick={() => void prepareEngine()}>
            Try loading again
          </button>
        </div>
      )}
          ...
          <div className="book">
            <section className="book-page entry-page">
              ...
              <p className="intro">
                ...
                backup. This example needs any two of the three below to recover
                the same secret.
              </p>
              <div className="selection-label">
                <strong>Choose your shares</strong>
                <span aria-live="polite">{selected.length} of 2 selected</span>
              </div>
              ...
              {!result ? (
                ...
                <div className="recovered">
                  ...
                  <details className="technical-note">
                    ...
                    <p>
                      The S string is compared with the published BIP93 example.
                      Addresses are compared with fixed expectations derived
                      separately from its published seed, using BIP86 Taproot,
                      Signet, account 0.
                    </p>
            ...
            >
              ...
              {checked ? (
                ...
                <div className="check-guide">
                  ...
                  <p>
                    The remaining characters carry the share data and checksum.
                  </p>
                  <p>
          ...
          <div className="book print-book">
            <section className="book-page entry-page">
              ...
              <ol className="paper-steps">
                ...
                <li>
                  Each page holds one clearly labeled share and a short practice
                  guide.
                </li>
                <li>
      ...
      {shares.map((share) => (
        <article className="printed-page" key={share.index}>
          ...
          <ol>
            ...
            <li>
              Open the Codex32 practice companion and select those two shares in
              Chapter I.
            </li>
            <li>
          ...
          <aside>
            ...
            learning only. Never send funds to the example wallet. Never enter a
            real backup into this website.
          </aside>
          <footer>
